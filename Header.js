      ...
      <div className=' h-full container mx-auto flex items-center px-4 justify-between'>
            ...
            <div className='flex items-center gap-7'>
                ...
                <div className='relative flex justify-center'>
                  ...
                  {/* ✅ About Link after Cart */}
                 <Link to="/about" className="text-base text-gray-700 hover:text-pink-600 hidden md:inline">
                 About
                 </Link>
                ...
                <div>
                  {
                    user?._id  ? (
                      <button onClick={handleLogout} className='px-3 py-1 rounded-full text-white bg-pink-600 hover:bg-blue-700'>Logout</button>
                    )
                    : (
                    <Link to={"/login"} className='px-3 py-1 rounded-full text-white bg-pink-600 hover:bg-blue-700'>Login</Link>
                    )
                  }
